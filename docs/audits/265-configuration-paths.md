...
manual configuration protocol. The Better Auth, SCIM and SSO writers of C03, C07, C08,
C18 and C19 participate since #314 (see [its evidence](../auth-scim-coordination-314.md));
the platform-administration, provisioning, import, demo and cleanup writers of those rows
remain with #312 and #318. Existing local transactions and SCIM transactional
