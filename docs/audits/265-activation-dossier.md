...
| E02 | Extension/mobile source repository, build provenance, accountable maintainer, distributed versions, server endpoints, exact command/queue formats and enforced update/disable capability | Those client scopes and any stricter admission their consumers can reach; #266. Both clients are retired (#282, #283; `docs/extension-clock-client-retirement-282.md`, `docs/mobile-clock-client-retirement-283.md`); their installed copies move to #329 |
