...
- Approval-card delivery work and every tracked remote message of the lifecycle's canonical workflows, returned as `delivery.work` and `delivery.messages`. See [Approval card delivery](approval-delivery.md).
