...
If you need to manage invitations, app access, social OAuth, SCIM, or payroll settings for one customer workspace, use that organization's admin settings rather than `/platform-admin`.
