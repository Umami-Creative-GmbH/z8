...
If you need to manage invitations, social OAuth, or payroll settings for one customer workspace, use that organization's admin settings rather than `/platform-admin`.
