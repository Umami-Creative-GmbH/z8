...
Advanced data warehousing can support downstream analysis in tools such as Snowflake or BigQuery when those destinations are enabled for your organization.
