...
| **Canceled** | Suspended | Subscription ended |
| **Unpaid** | Suspended | Payment failed after all retries |
...
Stripe will automatically retry the payment over several days. During this time, your access remains unchanged. If all retries fail, your organization is suspended until an organization admin updates billing.
