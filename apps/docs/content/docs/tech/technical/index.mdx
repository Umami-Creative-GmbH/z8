...
<Files>
  <Folder name="apps/webapp/src/lib/effect/services" defaultOpen>
    <File name="analytics.service.ts" />
    <File name="app-access.service.ts" />
    <File name="auth.service.ts" />
    <File name="authorization.service.ts" />
    <File name="change-policy.service.ts" />
    <File name="email.service.ts" />
    <File name="onboarding.service.ts" />
    <File name="permissions.service.ts" />
    <File name="reporting.service.ts" />
    <File name="time-entry.service.ts" />
    <File name="time-record.service.ts" />
    <File name="work-policy.service.ts" />
  </Folder>
</Files>
