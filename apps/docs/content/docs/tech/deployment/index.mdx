...
S3-compatible object storage is **required** for file uploads, exports, and attachments:
...
S3_ACCESS_KEY_ID=<access-key>
S3_SECRET_ACCESS_KEY=<secret-key>
S3_ENDPOINT=https://s3.amazonaws.com  # Or MinIO, R2, RustFS, etc.
```

### Local Development with RustFS

For local development, z8 includes RustFS as a lightweight S3-compatible server in the Docker Compose stack:
...
Buckets are automatically created on startup via the storage initialization service.
