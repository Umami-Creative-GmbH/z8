			...
			<div className="grid items-center gap-12 lg:grid-cols-2">
				...
				<div className="animate-scale-in relative" style={{ animationDelay: "0.3s" }}>
					...
					>
						...
						<div
							className="flex"
							style={{ backgroundColor: t.mockupBg, transition: "background-color 0.4s ease" }}
						>
							<div
								className="hidden w-52 border-r p-4 md:block"
								style={{
									backgroundColor: t.mockupSidebar,
							...
							>
								<div className="mb-4 flex items-center gap-2">
									...
									<span className="text-[12px] font-semibold">{copy.mockup.company}</span>
								</div>
								{copy.mockup.sidebarItems.map((item, i) => (
									<div
										key={item}
							...
							<div className="flex-1 p-5">
								<div className="mb-4 flex items-center justify-between">
									<div>
										<div className="text-[13px] font-semibold">{copy.mockup.dateLabel}</div>
										<div className="text-[11px]" style={{ color: t.textTertiary }}>
											{copy.mockup.activeEmployees}
										</div>
									</div>
									<div className="flex gap-2">
										<div
											className="rounded-lg px-3 py-1.5 text-[11px] font-medium"
											style={{ backgroundColor: t.mockupBarInactive, color: t.textSecondary }}
										>
											{copy.mockup.weekLabel}
										</div>
										<div
											className="rounded-lg px-3 py-1.5 text-[11px] font-medium"
											style={{ backgroundColor: t.surface, color: t.surfaceText }}
										>
											{copy.mockup.monthLabel}
										</div>
									</div>
								</div>
								<div
									className="mb-4 flex h-32 items-end gap-1.5 rounded-xl p-4"
								...
								<div className="rounded-xl border" style={{ borderColor: t.border }}>
									{copy.mockup.employees.map((name) => (
										<div
											key={name}
