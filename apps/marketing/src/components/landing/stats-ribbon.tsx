		...
		>
			...
			>
				{stats.map((s, i) => (
					...
					>
						<span
							className="text-[clamp(2rem,4vw,3.2rem)] font-extrabold tracking-[-0.03em]"
							style={{ color: dark ? "#0a0a0a" : "#fff" }}
						>
							{s.value}
						</span>
						<span
						...
						<span className="mt-0.5 text-[11px]" style={{ color: dark ? "#888" : "#555" }}>
							{s.sub}
						</span>
					</div>
				))}
