...
pnpm --dir "$app_directory" exec vitest run --no-file-parallelism \
	...
	src/lib/approvals/domain-adapters/time-correction-legacy-chain-observation.integration.test.ts \
	...
	src/lib/approvals/domain-adapters/absence-legacy-chain-observation.integration.test.ts \
	...
	src/lib/approvals/delivery/discord-delivery.integration.test.ts \
	src/lib/approvals/escalation/replacement-delivery.integration.test.ts \
