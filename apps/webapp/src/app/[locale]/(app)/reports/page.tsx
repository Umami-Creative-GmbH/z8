...
export default async function ReportsPage() {
	...
	const employees = accessibleEmployeesResult.success
		? accessibleEmployeesResult.data
		: [];
					...
					<div className="@container/main flex flex-1 flex-col gap-6 py-4 md:py-6">
						...
						<div className="px-4 lg:px-6">
							...
							<p className="text-muted-foreground">
								Generate comprehensive work hour and absence reports with tax-relevant home
								office data
							</p>
						</div>
