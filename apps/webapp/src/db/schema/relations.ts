...
export const travelExpenseClaimRelations = relations(travelExpenseClaim, ({ one, many }) => ({
	organization: one(organization, {
...
export const travelExpenseAttachmentRelations = relations(travelExpenseAttachment, ({ one }) => ({
...
export const travelExpensePolicyRelations = relations(travelExpensePolicy, ({ one }) => ({
	organization: one(organization, {
...
export const travelExpenseDecisionLogRelations = relations(travelExpenseDecisionLog, ({ one }) => ({
	claim: one(travelExpenseClaim, {
...
export const auditPackRequestRelations = relations(auditPackRequest, ({ one }) => ({
	organization: one(organization, {
...
export const auditPackArtifactRelations = relations(auditPackArtifact, ({ one }) => ({
...
export const customRolePermissionRelations = relations(customRolePermission, ({ one }) => ({
...
export const employeeCustomRoleRelations = relations(employeeCustomRole, ({ one }) => ({
	employee: one(employee, {
...
export const customRoleAuditLogRelations = relations(customRoleAuditLog, ({ one }) => ({
	organization: one(organization, {
