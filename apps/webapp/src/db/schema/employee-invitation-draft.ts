...
export const employeeInvitationDraft = pgTable(
	...
	(table) => [
		...
		// The invitation/org index and composite FK are migration-only because invitation
		// is generated by Better Auth and cannot be augmented safely from this schema module.
		// Latest snapshots copy their exact deployed metadata forward from the 0050 snapshot.
