...
const parsedEnv = createEnv({
	server: {
		...
		S3_PUBLIC_ENDPOINT: z.url("S3_PUBLIC_ENDPOINT must be a valid URL"),
		...
		S3_PRIVATE_ENDPOINT: z.url("S3_PRIVATE_ENDPOINT must be a valid URL").optional(),
		...
		AUDIT_SERVICE: z.string().optional(),
		AUDIT_ENDPOINT: z.string().optional(),
		...
		MICROSOFT_APP_TYPE: z.enum(["MultiTenant", "SingleTenant"]).optional(),
	...
	runtimeEnv: {
		...
		AUDIT_SERVICE: process.env.AUDIT_SERVICE,
		AUDIT_ENDPOINT: process.env.AUDIT_ENDPOINT,
