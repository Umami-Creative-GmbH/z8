				...
				<div className="space-y-6">
					...
					<div className="space-y-2">
						...
						<div className="flex items-center justify-between text-xs">
							...
							<span className={getStatusColor(weekPercentage)}>{weekPercentage.toFixed(0)}%</span>
						</div>
					</div>
					...
					<div className="space-y-2">
						...
						<div className="flex items-center justify-between text-xs">
							...
							<span className={getStatusColor(monthPercentage)}>{monthPercentage.toFixed(0)}%</span>
						</div>
					</div>
				</div>
			)}
