...
interface LocationEmployeeDialogProps {
...
export function LocationEmployeeDialog({
	...
	const { data: employees, isLoading } = useQuery({
		queryKey: [...queryKeys.locations.employees(locationId), "available"],
		queryFn: async () => {
									...
									<div className="flex items-center space-x-2">
										...
										<div className="grid gap-1.5 leading-none">
											...
											<p className="text-xs text-muted-foreground">
												{t(
													"settings.locations.primarySupervisorHelp",
													"Mark as the main supervisor for this location",
												)}
											</p>
										</div>
									</div>
