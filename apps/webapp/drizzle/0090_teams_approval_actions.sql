...
-- presentation or delivery control rows are inserted.
...
ALTER TABLE "approval_delivery_control" ADD CONSTRAINT "approval_delivery_control_provider_check" CHECK ("provider" IN ('telegram', 'teams'));--> statement-breakpoint
ALTER TABLE "approval_delivery_message" DROP CONSTRAINT "approval_delivery_message_provider_check";--> statement-breakpoint
ALTER TABLE "approval_delivery_message" ADD CONSTRAINT "approval_delivery_message_provider_check" CHECK ("provider" IN ('telegram', 'teams'));--> statement-breakpoint
ALTER TABLE "approval_delivery_work" DROP CONSTRAINT "approval_delivery_work_provider_check";--> statement-breakpoint
ALTER TABLE "approval_delivery_work" ADD CONSTRAINT "approval_delivery_work_provider_check" CHECK ("provider" IN ('telegram', 'teams'));
